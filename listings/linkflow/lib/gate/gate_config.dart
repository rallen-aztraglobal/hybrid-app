...
class GateConfig {
  ...
  static const String bundleId = 'com.wrenfield.linkflow6142';
  ...
  /// **已填**（2026-09-09 建）。Adjust 里 App 名 `LinkFlow`，Android 平台已配
  /// `com.wrenfield.linkflow6142`（store google play），reporting currency PHP、
  /// 勾了「用户群仅在欧洲经济区之外」—— 逐项与 ColorStack 一致。
  ///
  /// 若改回 `TODO_` 前缀，`TrackingService` 会跳过 Adjust 初始化，全链路 no-op。
  static String get adjustAppToken => 'r1akj2bp7xts';
