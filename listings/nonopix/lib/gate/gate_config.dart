...
class GateConfig {
  ...
  static const String bundleId = 'com.oakmere.nonopix3927';
  ...
  /// **已填**（2026-09-09 建）。Adjust 里 App 名 `NonoPix`，Android 平台已配
  /// `com.oakmere.nonopix3927`（store google play），reporting currency PHP、
  /// 勾了「用户群仅在欧洲经济区之外」，与 TileFit / CalcPad 同口径。
  ///
  /// 若改回 `TODO_` 前缀，`TrackingService` 会跳过 Adjust 初始化，全链路 no-op。
  static String get adjustAppToken => 'fpny286clibk';
