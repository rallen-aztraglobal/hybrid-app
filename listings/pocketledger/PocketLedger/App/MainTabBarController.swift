...
final class MainTabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        delegate = self
        viewControllers = [
            makeNav(root: OverviewViewController(), title: "Overview", symbol: "chart.pie.fill"),
            makeNav(root: TransactionsViewController(), title: "Transactions", symbol: "list.bullet"),
            makeNav(root: AccountsViewController(), title: "Accounts", symbol: "creditcard.fill"),
