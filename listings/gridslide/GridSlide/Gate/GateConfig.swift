...
enum GateConfig {
    ...
    static let bundleId = "com.fernvale.gridslide"
    ...
    /// Adjust 后台的 App 名为 `GridSlide`，iOS 平台 `com.fernvale.gridslide`
    ...
    static let adjustAppToken = "4w8yd18jd0qo"
    ...
    ///
    /// 取自 Adjust 后台 App `GridSlide` 的 Events 页。与上面的 `adjustAppToken` 成对生效：
    /// `TrackingService.trackOpenBLanding()` 要求两者都已配置才会发 Adjust 事件。
    static let adjustOpenBLandingToken = "intubq"
