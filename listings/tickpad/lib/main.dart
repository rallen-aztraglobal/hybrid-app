...
void main() {
  ...
  // 竖屏锁定：计数器是纵向一列一列排的，横屏下一屏放不下几个，反而更难点。
...
class TickPadApp extends StatelessWidget {
  const TickPadApp({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // 入口是启动闸：先做 AB 面判定，再决定进 A 面（CountersScreen）还是 B 面（WebScreen）。
