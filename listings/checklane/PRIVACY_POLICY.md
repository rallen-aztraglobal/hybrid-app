# CheckLane — Privacy Policy

**Last updated: 2026-09-09**

CheckLane ("the app") is published by Aztra Global. This policy explains what the app
collects, why, and what it does not collect. It covers the Android app distributed on
Google Play under the package name `com.thornbury.checklane2894`.
...
The app saves your checklists, using Android's standard app-preferences storage:

| Key | Value |
| --- | --- |
| `checklane_lists_v1` | your checklists: the **title and item text you type**, and which items are ticked |

This is **text you type yourself**. It stays on your device: it is never uploaded, never
attached to analytics events, and never sent to our server. Uninstalling the app deletes
it.
...
- You can delete everything the app stores locally by uninstalling it, or via
  **Settings → Apps → CheckLane → Storage → Clear data**.
